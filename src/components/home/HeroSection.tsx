...
import { FrameAnimationDemo } from "./FrameAnimationDemo";

export function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center pt-20 bg-muted/30">
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            >
              Create stunning custom frames, smart digital badges, and AI-generated visuals 
              that boost attendee engagement and maximize your event's visibility.
            </motion.p>
