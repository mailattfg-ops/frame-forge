  ...
  return (
    <section className="py-24 relative overflow-hidden bg-secondary">
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary-foreground/10 mb-8">
            <Zap className="w-4 h-4 text-secondary-foreground" />
            <span className="text-sm text-secondary-foreground/90">Ready to Transform Your Events?</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button asChild variant="outline" size="lg" className="border-secondary-foreground/30 bg-secondary-foreground text-foreground hover:bg-secondary-foreground/90 text-lg px-8 py-6 group">
